...
async function main() {
    ...
    const atrractionsObj = { title: "Достопримечательности Карелии", link: "attractions.html", keywords: "Онежское озеро, Кижи, Валаам, Ладожское озеро, Валаамский архипелаг, Горный Парк, Мраморный карьер, Ладога, Ладожское озеро", description: "Ладожское озеро&nbsp;&mdash; настоящая жемчужина Карелии и Ленинградской области. Его суровая и&nbsp;величественная красота волнует людей не одно столетие. Такие великие художники, как Шишкин, Клодт, Куинджи, посещали эти места и&nbsp;передавали их&nbsp;красоту в&nbsp;своих полотнах. Но&nbsp;можно&nbsp;ли передать те&nbsp;эмоции и впечатления от&nbsp;пребывания у&nbsp;Ладоги!", text: attractions };
