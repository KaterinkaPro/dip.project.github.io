...
async function main() {
    ...
    const legendsObj = { title: "Легенды Карелии", link: "legends.html", description: "Древний эпос и легенды Карелии собраны воедино и представляют собой", keywords: "Легедны, эпос, Ладога, монстр, капитан, Сигвард, гигант", text: legends }; //! TODO description, keywords
