...
async function main() {
    ...
    const sigvardObj = { title: "Капитан Сигвард", link: "legends/captain_sivgard.html", description: "Север хранит в&nbsp;себе множество тайн и&nbsp;загадок. Многие легенды и&nbsp;мифы передаются из&nbsp;уст в&nbsp;уста, из&nbsp;поколения в&nbsp;поколение, и&nbsp;у&nbsp;каждого народа свой фольклор.", keywords: "qwerty", text: sigvard }; //! TODO description, keywords
    const giantsObj = { title: "О Великинах", link: "legends/giants.html", description: "На&nbsp;Ладожском побережье существует предание, что когда-то в&nbsp;этих местах жили огромные люди, так называемые метелиляйнены, или мунккилайнены, которых постепенно вытеснили отсюда лапландцы и&nbsp;финны. Само название пошло от&nbsp;финского &laquo;meteli&raquo;&nbsp;&mdash; шум, все потому, что во&nbsp;время их&nbsp;передвижения по&nbsp;лесам, они создавали много шума. До&nbsp;сих пор люди обнаруживают следы их&nbsp;существования: огромные кости и&nbsp;плуги. Также есть странные места с&nbsp;нагромождением огромных валунов.", keywords: "qwerty", text: giants }; //! TODO description, keywords
     const monsterObj = { title: "Неизвестный монстр или тайна Ладожского озера", link: "legends/monster.html", description: "Я&nbsp;не&nbsp;знаю ни&nbsp;одного глубоководного озера, в&nbsp;котором хотя&nbsp;бы раз не&nbsp;было замечено некое явление, не&nbsp;поддающееся логическому и&nbsp;научному объяснению.", keywords: "qwerty", text: monster }; //! TODO description, keywords
