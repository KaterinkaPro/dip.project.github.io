...
async function main() {
    ...
    const natureObj = { title: "Природа Карелии", link: "about_karelia/nature.html", description: "<p>Природа Карелии очаровывает любого, кто хоть единожды бывал в&nbsp;этих местах. И&nbsp;это неслучайно. Красивая северная природа изобилует буйными реками с&nbsp;крутыми порогами, девственно чистыми лесами, разнообразной флорой и&nbsp;фауной. В&nbsp;Карелии насчитывается более 60&nbsp;000&nbsp;озер, самые известные и&nbsp;самые крупные из&nbsp;которых&nbsp;&mdash; Онежское и&nbsp;Ладожское. В&nbsp;республике протекает множество рек и&nbsp;речушек, но&nbsp;все они короткие. Самая длинная из&nbsp;них&nbsp;&mdash; Кемь протяженностью в&nbsp;360&nbsp;км. Также есть и&nbsp;болота и&nbsp;водопады. Именно водоемы в&nbsp;сочетании с&nbsp;карельскими лесами и&nbsp;создают тот удивительный климат, который очаровывает всех.</p>", text: "1234" + nature };
    
    const atrractionsObj = { title: "Достопримечательности Карелии", link: "attractions.html", description: "Ладожское озеро&nbsp;&mdash; настоящая жемчужина Карелии и Ленинградской области. Его суровая и&nbsp;величественная красота волнует людей не одно столетие. Такие великие художники, как Шишкин, Клодт, Куинджи, посещали эти места и&nbsp;передавали их&nbsp;красоту в&nbsp;своих полотнах. Но&nbsp;можно&nbsp;ли передать те&nbsp;эмоции и впечатления от&nbsp;пребывания у&nbsp;Ладоги!", text: "1234" + attractions };
    
    //! TODO
    // const nameObj1 = { title: "", link: "", description: "", text: name1 };
    // const nameObj2 = { link: "", description: "", text: name2 };
    // const nameObj3 = { link: "", description: "", text: name3 };
    // const nameObj4 = { link: "", description: "", text: name4 };
    // const nameObj5 = { link: "", description: "", text: name5 };
    // const nameObj6 = { link: "", description: "", text: name6 };
    // const nameObj7 = { link: "", description: "", text: name7 };
    // const nameObj8 = { link: "", description: "", text: name8 };
    ...
    function sortArticles(value, maxCharCount) {
        ...
        for (let i = 0; i < textsArray.length; i++) {
            if (textsArray[i].text.toLowerCase().includes(value.toLowerCase())) {
                textsArray[i].description = textsArray[i].description.slice(0, maxCharCount) + "...";
